...
const DEFAULT_INNER_GRADIENT = "linear-gradient(145deg, rgba(11,79,138,0.92) 0%, rgba(58,183,165,0.48) 100%)";
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        "--behind-glow-color": behindGlowColor ?? "rgba(58, 183, 165, 0.35)",
        ...
        <section className="pc-card">
          <div className="pc-inside">
            ...
            <div className="pc-content pc-avatar-content">
              {/* React Bits source uses img here for the animated stacked card effect. */}
